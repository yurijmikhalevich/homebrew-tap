class TorchvisionPython314AT0250 < Formula
  ...
  def install
    ...
    pth_contents = "import site; site.addsitedir('#{Formula["pytorch-python314@2.10.0"].opt_libexec/site_packages}')\n"
  ...
  test do
    ...
    CPP
    pytorch = Formula["pytorch-python314@2.10.0"]
